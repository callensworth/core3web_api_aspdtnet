...
namespace web_api_tests
{
    public class ShoppingCartControllerTest
    {
        ...
        public void Get_WhenCalled_ReturnsAllItems()
        {
            ...
            //                    V    V        V     then return the list.
            //                    V    V        V                    V
            var items = Assert.IsType<List<ShoppingItem>>(okResult.Value);
            
            //       is the shopping cart only three items?
        ...
        public void GetById_ExistingGuidPassed_ReturnsOkResult()
        {
            ...
            // Assert
            //         did we get the same object type?
            Assert.IsType<OkObjectResult>(okResult.Result);
        }
        ...
        public void GetById_ExistingGuidPassed_ReturnsRightItem()
        {
            ...
            // Act
            OkObjectResult okResult = (OkObjectResult)_controller.Get(testGuid).Result;

            // Assert
            //           is it a shopping-item?
